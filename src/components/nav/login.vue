<template>
	<div class='animate' :style='!showLogin ? {opacity: 0, height: 0, overflow: "hidden"} : ""'>
		<div class="login-up-arrow"></div>
		<div class='login-main'>
			<div class='login-insert-container animate-five' 
			...
			backgroundImage: "url(static/alltheme/"+ bgpic +")"}'>
				...
				<div class='login-insert-box lf'>
					...
					<div class='input-container lf'>
						...
						<p>
							<span>密码</span>
							<input type='password' @keyup.enter='login' v-model='loginUP.pwd'>
						</p>
					</div>
				</div>
				...
				<div class='rigist-insert-box lf'>
					...
					<div class='input-container lf'>
						...
						<p>
							<span>密码</span>
							<input type='password' @keyup.enter='rigist' v-model='rigistUP.pwd'>
						</p>
					</div>
				</div>
			</div>
			...
			<!-- 切换柱子 -->
			<p class='toggle-bar login-bar animate-five'
			:style='{backgroundColor: loginBar, width: loginWidth}' @click="loginCl">
				<span>Log In</span>
				<span class='confirm-circle rt animate-five' 
				:class='loginConfirm ? "active-confirm" : ""'
				@click='login'>confirm
				</span>
			</p>
			<p class='toggle-bar rigist-bar animate-five' 
			:style='{backgroundColor: rigistBar, width: rigistWidth}' @click="rigistCl">
				<span>Register</span>
				<span class='confirm-circle lf animate-five' 
				:class='!loginConfirm ? "active-confirm" : ""'
				@click='rigist'>
				confirm</span>
			</p>
...
<style>
	...
	/*登录注册框*/
	.login-insert-box, .rigist-insert-box {
		width: 50%;
		height: 100%;
