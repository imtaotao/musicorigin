        ...
        <li v-for="(key, i) in songList" class="songList-content lf">
          <div class="song-list-img">
            ...
            <span class="song-list-play animate"
              ><i @click="playMusicList(key.id)"></i
            ></span>
            ...
            <b
              class="mask-layer"
              :title="key.copywriter"
              @click="musicList(key.id)"
            ></b>
          </div>
...
.new-music-content li:nth-child(2n + 1) {
  border-right: 0.5px solid rgba(208, 210, 211, 0.3);
}
