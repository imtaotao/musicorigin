		...
		<ul class="music-charts">
			<li class="lf" v-for='(key, i) in rankingList' v-show='key.playCount'>
				<div class="ranking-img lf">
					...
					<span class="song-list-play animate"><i @click='playMusic(key.listId)'></i></span>
					<b class="ranking-mask-layer" @click='musicList(key.listId)'></b>
				</div>
				<div class="ranking-musicList lf">
					<h6>{{key.name}}</h6>
					<p v-for='(item, j) in key.info' class="musin-single hidden-text" 
	...
	export default {
		data () {
			return {
				...
				isloading : true,
				rankingList: [
					{name: '音乐新歌榜', 			  ids: 0,  playCount: '', listId: null, info: [], originInfo: []},
					{name: '音乐热歌榜', 			  ids: 1,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: '原创歌曲榜', 		      ids: 2,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: '音乐飙升榜', 			  ids: 3,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: '音乐电音榜', 			  ids: 4,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: 'UK排行榜周榜', 			  ids: 5,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: '美国Billboard周榜', 	  ids: 6,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: 'KTV嗨榜', 				  ids: 7,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: 'iTunes榜', 				  ids: 8,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: 'Hit FM Top榜', 			  ids: 9,  playCount: '', listId: null, info: [], originInfo: {}},
					{name: '日本Oricon周榜', 		  ids: 10, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '韩国Melon排行榜周榜', 	  ids: 11, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '韩国Mnet排行榜周榜', 	  ids: 12, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '韩国Melon原声周榜', 	  ids: 13, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '中国TOP排行榜(港台榜)',   ids: 14, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '中国TOP排行榜(内地榜)',   ids: 15, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '香港电台中文歌曲龙虎榜',  ids: 16, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '华语金曲榜', 			  ids: 17, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '中国嘻哈榜', 			  ids: 18, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '法国 NRJ EuroHot 30周榜', ids: 19, playCount: '', listId: null, info: [], originInfo: {}},
					{name: '台湾Hito排行榜', 		  ids: 20, playCount: '', listId: null, info: [], originInfo: {}},
					{name: 'Beatport全球电子舞曲榜',  ids: 21, playCount: '', listId: null, info: [], originInfo: {}}
				]
			}
		},
		computed: {
	    ...
	    methods: {
	    	...
	    	requestRanking () {
	    		...
	    		for (; this.reqIndex < length; this.reqIndex++) {
	    			...
	    			this.$ajax.get(this.host + `/top/list?idx=${val.ids}`).then(({data}) => {
						if (data.code !== 200) {
