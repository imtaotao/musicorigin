    ...
    <div class="audio-controls">
      <div class="audio-content">
          ...
          <div class="progressbar-bottom">
            <div class="music-time">
              <span class="start-time">{{
                playConver(Number(nowPlayTime))
              }}</span>
              <span class="end-time">{{
                conver(Number(nowInfo.duration))
              }}</span>
            </div>
            <div class="music-processbar">
              ...
              <span
                class="bar-play"
                @input="playInput($event)"
                @change="playChange($event)"
              >
        ...
        <div class="audio-operating">
          ...
          <i
            class="icon-collect1-list list-collect"
            :class="
              getCollect().status ? 'icon-collect2-list' : 'icon-collect1-list'
            "
        ...
        <div
          class="equalizer-box"
          :style="{ height: equalizerSwitch ? '300px' : 0 }"
        >
          <!-- 标题 -->
        ...
        <div
          class="music-list"
          :style="{ height: playListSwitch ? '300px' : 0 }"
        >
          ...
          <div class="list-content">
            <ul class="scroll">
              <li
                ...
                @dblclick="
                  dblclick($event, key.id, {
                    url: key.picUrl,
                    duration: key.musicInfo[3],
                    name: key.musicInfo[1],
                  })
                "
              >
                <span
                  ...
                  @click="
                    j === 5
                      ? deleteMusic($event, i, key.id)
                      : j === 4
                      ? collectMusic(musicList[i].id)
                      : ''
                  "
                >
                  {{ conver(item, j) }}
          ...
          <div class="list-lyrics equalizer-title">
            <div
              class="totallyr-box lyr-animate"
              :style="{ transform: 'translateY(' + -28 * translateY + 'px)' }"
            >
              <div
                class="single-lyr"
                v-for="(key, i) in setLyr()"
                :data-time="key.time"
              >
        ...
        <div
          class="play-order"
          :style="{ height: playOrderSwitch ? '130px' : 0 }"
        >
          <ul>
...
.single-bar:nth-child(4) {
  left: 30%;
}
.single-bar:nth-child(5) {
  left: 40%;
}
.single-bar:nth-child(6) {
  left: 50%;
}
.single-bar:nth-child(7) {
  left: 60%;
}
.single-bar:nth-child(8) {
  left: 70%;
}
.single-bar:nth-child(9) {
  left: 80%;
}
.single-bar:nth-child(10) {
  left: 90%;
}
.single-bar span {
  display: inline-block;
